...
```
**The Prediction is $\approx 61.5$ ng for the Useful Range, given that brightness is $80$% and contrast is $75$% **
...
**$\therefore$ there is a linear relationship existing betweem Contrast and Useful Range.**
